...
//validation functions, only 1 here
const myRequiredVeeFunk = (value) => {
  if (!value) {
    return (
...
const Login = () => {
  ...
  <img
        ...
        <Form onSubmit={handleLogin} ref={form}>
          ...
          <div className="form-group">
            <button className="btn btn-primary btn-block m-3" disabled={loading}>
              {loading && (
